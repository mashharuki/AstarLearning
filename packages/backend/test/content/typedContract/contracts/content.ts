...
import ABI from '../../artifacts/content.json';
import QueryMethods from '../query/content';
import BuildExtrinsicMethods from '../build-extrinsic/content';
import TxSignAndSendMethods from '../tx-sign-and-send/content';
import MixedMethods from '../mixed-methods/content';
import EventsClass from '../events/content';
