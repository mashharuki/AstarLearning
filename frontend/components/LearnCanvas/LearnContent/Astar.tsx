...
const Astar = ():JSX.Element => {
    ...
    return (
            <div>
                <h1 id="astar-networkとは">Astar Networkとは</h1>
                <ul>
                    <li>
                ...
                <h3 id="astar-networkの特徴">Astar Networkの特徴</h3>
                <ol>
                    <li>
                ...
                <h3 id="astarnetworkはどんなところから支持を得ている">AstarNetworkはどんなところから支持を得ている?</h3>
                ...
                <h3 id="astar-japan-labについて">Astar Japan Labについて</h3>
                ...
                <h3 id="startale-labs-japan">Startale Labs Japan</h3>
                <ul>
                    <li>プロダクト開発</li>
                </ul>
