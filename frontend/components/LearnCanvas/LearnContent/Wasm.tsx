...
const Wasm = () => {
    ...
    return (
        <div>
            ...
            <h3 id="バイナリ・フォーマットとは">バイナリ・フォーマットとは</h3>
            <p>テキストフォーマットのように、特定の環境に依存することなく、テキストエディタでデータを読み書きすることはできないが、代わりにデータの記録方式はプログラムで任意に決定できるため、情報を効率よく構造化することが可能になる。</p>
            <h3 id="wasiwebassembly-system-interfaceとは">WASI(WebAssembly System Interface)とは</h3>
            ...
            <h3 id="なぜスマートコントラクトにwebassemblyを対応するのか？">なぜスマートコントラクトにWebAssemblyを対応するのか？</h3>
            <ol>
            ...
            <h3 id="astarにおけるwasmコントラクト開発言語">AstarにおけるWASMコントラクト開発言語</h3>
            <p>現在は以下の通り</p>
            <ol>
                <li>!ink</li>
                <li>!ask</li>
            </ol>
            <h3 id="astarにおけるwasmコントラクトの開発フレームワーク">AstarにおけるWASMコントラクトの開発フレームワーク</h3>
            <p>現在は、以下の通り</p>
            <ol>
                <li>swanky</li>
            </ol>
